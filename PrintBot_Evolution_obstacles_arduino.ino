...
void setup()
{
  ...
  servos[8].attach(8); /* Rueda izquierda */

  servos[9].attach(9); /* Rueda derecha */

  servos[11].attach(11); /*Servo que mueve el sensor de distancia */

  pinMode( 5 , INPUT ); /* Cable rojo */

  pinMode( 4 , OUTPUT ); /* Cable azul */
